...
# Metropolis-Hastings MCMC algorithm for distributing stars in galaxies
...
xmin, xmax = 0, 5
ymin, ymax = -1, 1
plt.hexbin(samples[:, 0], samples[:, 1], gridsize=50, cmap='plasma', extent=[xmin, xmax, ymin, ymax], bins='log')
plt.colorbar()
